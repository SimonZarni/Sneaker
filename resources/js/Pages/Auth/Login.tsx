...
import { googleNativeLogin } from "@/utils/googleAuth";
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center px-8 py-16">
                <div className="w-full max-w-sm">
                    ...
                    <form onSubmit={submit} className="space-y-8">
                        ...
                        {/* ── Google OAuth ── */}
                        {googleError && (
                            <p className="text-[9px] font-black uppercase tracking-wide text-red-500 text-center">
                                {googleError}
                            </p>
                        )}
                        <button
                            ...
                            onClick={async () => {
                                ...
                                if (Capacitor.isNativePlatform()) {
                                    ...
                                    try {
                                        ...
                                        // User cancelled sign-in — swallow silently
                            ...
                            className="flex items-center justify-center gap-3 w-full border-2 border-brand-surface hover:border-brand-charcoal py-4 text-[10px] font-black uppercase tracking-[0.3em] text-brand-charcoal transition-colors group disabled:opacity-40"
                        >
