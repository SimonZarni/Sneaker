                ...
                <div className="w-full max-w-sm">
                    ...
                    <form onSubmit={submit} className="space-y-8">
                        ...
                        <button
                            ...
                            className="flex items-center justify-center gap-3 w-full border-2 border-brand-surface hover:border-brand-charcoal py-4 text-[10px] font-black uppercase tracking-[0.3em] text-brand-charcoal transition-colors group disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {googleLoading ? (
                                <>
