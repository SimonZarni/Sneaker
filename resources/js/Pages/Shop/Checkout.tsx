...
//         shipping_country:      '',
//         payment_method:        'Credit Card',   // 'Credit Card' | 'COD'
//         cardholder_name:       '',
//         card_number:           '',              // sent as last-4 only
//         card_expiry:           '',
//         card_cvc:              '',
//     });
...
//         // store only last-4 for the backend
...
//         (acc: number, item: any) =>
//             acc + parseFloat(item.product_variant.product.base_price) * item.quantity,
//         0,
//     );
...
//                     <Link
//                         href="/shop"
//                         className="text-[10px] font-black uppercase tracking-[0.3em] hover:text-brand-slate transition-colors"
//                     >
//                         ← Exit Checkout
//                     </Link>
...
//                     {/* 02. SHIPPING + PAYMENT FORM */}
//                     <form onSubmit={handleSubmit} className="space-y-16">

//                         {/* Shipping */}
//                         <section>
//                             <div className="flex justify-between items-end mb-10">
//                                 <h2 className="text-[10px] font-black uppercase tracking-[0.4em] text-brand-slate/40">
//                                     Shipping Information
//                                 </h2>
//                                 <span className="text-[8px] font-black text-brand-slate/30 uppercase italic">
...
//                                         <span className={errorCls}>{errors.shipping_full_name}</span>
//                                     )}
//                                 </div>
...
//                                         <span className={errorCls}>{errors.shipping_phone}</span>
//                                     )}
//                                 </div>
...
//                                         <span className={errorCls}>{errors.shipping_country}</span>
//                                     )}
//                                 </div>
...
//                                     <input
//                                         type="text"
//                                         value={data.shipping_address_line}
//                                         onChange={(e) => setData('shipping_address_line', e.target.value)}
//                                         className={inputCls}
//                                     />
//                                     {errors.shipping_address_line && (
//                                         <span className={errorCls}>{errors.shipping_address_line}</span>
//                                     )}
//                                 </div>
...
//                                         <span className={errorCls}>{errors.shipping_city}</span>
//                                     )}
//                                 </div>
...
//                                     <input
//                                         type="text"
//                                         value={data.shipping_state_region}
//                                         onChange={(e) => setData('shipping_state_region', e.target.value)}
//                                         className={inputCls}
//                                     />
//                                     {errors.shipping_state_region && (
//                                         <span className={errorCls}>{errors.shipping_state_region}</span>
//                                     )}
//                                 </div>
...
//                         {/* 03. PAYMENT METHOD SELECTION */}
//                         <section>
//                             <h2 className="text-[10px] font-black uppercase tracking-[0.4em] mb-10 text-brand-slate/40">
//                                 Payment Method
//                             </h2>
...
//                                     className={`flex-1 py-8 border text-[10px] font-black uppercase tracking-[0.2em] transition-all flex flex-col items-center gap-3 ${
//                                         isCard
//                                             ? 'border-brand-charcoal bg-brand-charcoal text-brand-white shadow-xl'
//                                             : 'border-brand-surface text-brand-slate hover:border-brand-charcoal'
//                                     }`}
//                                 >
//                                     {/* Card icon */}
//                                     <svg
//                                         className={`w-6 h-6 ${isCard ? 'text-brand-white' : 'text-brand-slate/40'}`}
...
//                                     {/* Cash icon */}
//                                     <svg
//                                         className={`w-6 h-6 ${isCOD ? 'text-brand-white' : 'text-brand-slate/40'}`}
//                                         fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}
//                                     >
...
//                             {/* ── CARD DETAILS FORM (animated reveal) ── */}
//                             <div
//                                 className={`overflow-hidden transition-all duration-500 ease-in-out ${
//                                     isCard ? 'max-h-[600px] opacity-100' : 'max-h-0 opacity-0'
//                                 }`}
//                             >
...
//                                                 onChange={(e) => setData('cardholder_name', e.target.value.toUpperCase())}
//                                                 className={inputCls}
//                                                 placeholder="AS PRINTED ON CARD"
//                                                 autoComplete="cc-name"
//                                             />
//                                             {errors.cardholder_name && (
//                                                 <span className={errorCls}>{errors.cardholder_name}</span>
//                                             )}
//                                         </div>
...
//                                             />
//                                             {errors.card_number && (
//                                                 <span className={errorCls}>{errors.card_number}</span>
//                                             )}
//                                         </div>
...
//                                                 />
//                                                 {errors.card_expiry && (
//                                                     <span className={errorCls}>{errors.card_expiry}</span>
//                                                 )}
//                                             </div>
...
//                                                     value={data.card_cvc}
//                                                     onChange={(e) =>
//                                                         setData('card_cvc', e.target.value.replace(/\D/g, '').slice(0, 4))
//                                                     }
//                                                     className={`${inputCls} font-mono tracking-[0.15em]`}
//                                                     placeholder="•••"
//                                                     autoComplete="cc-csc"
//                                                 />
//                                                 {errors.card_cvc && (
//                                                     <span className={errorCls}>{errors.card_cvc}</span>
//                                                 )}
//                                             </div>
//                                         </div>
//                                     </div>
...
//                                             Payment on Delivery
//                                         </p>
//                                         <p className="text-[10px] text-brand-slate/50 leading-relaxed font-medium">
//                                             Have the exact amount ready when your order arrives. Our courier will collect
//                                             payment at the door.
//                                         </p>
//                                     </div>
//                                 </div>
...
//                         <h2 className="text-[10px] font-black uppercase tracking-[0.4em] mb-10 text-brand-slate/40 text-center">
//                             Order Manifest
//                         </h2>
...
//                                 <span className="text-4xl font-black tracking-tightest leading-none tabular-nums">
//                                     ${subtotal.toFixed(2)}
//                                 </span>
//                             </div>
//                         </div>
...
//                     Encrypted End-to-End Secure Transaction
//                 </p>
//             </footer>
//         </div>
//     );
