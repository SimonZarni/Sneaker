    ...
    return (
        <div style={{ minHeight: "100vh", backgroundColor: "#fff", fontFamily: "inherit" }}>
            ...
            <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "0 32px 80px" }}>
                {products.length === 0 ? (
                    <div style={{ textAlign: "center", padding: "80px 0", border: "1px solid #EEF3EE", backgroundColor: "#fafafa" }}>
                        ...
                        <button onClick={clearAll} style={{ fontSize: "9px", fontWeight: 900, textTransform: "uppercase", letterSpacing: "0.15em", color: "#5B8C5A", background: "none", border: "none", borderBottom: "1px solid #5B8C5A", paddingBottom: "1px", cursor: "pointer" }}>
                            Clear filters
                        </button>
                    </div>
                ) : (
...
function ProductCard({ product, auth }: { product: Product; auth: any }) {
    ...
    return (
        ...
        >
            {/* Sale badge */}
            {product.is_on_sale && (
                <div style={{ position: "absolute", top: "16px", left: "16px", zIndex: 10, backgroundColor: "#5B8C5A", color: "#fff", fontSize: "7px", fontWeight: 900, textTransform: "uppercase" as const, letterSpacing: "0.15em", padding: "3px 8px" }}>
                    Sale
                </div>
            )}
            {/* Wishlist heart */}
