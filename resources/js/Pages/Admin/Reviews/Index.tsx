            ...
            <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <p style={{ fontSize: "9px", fontWeight: 700, color: "rgba(45,50,62,0.4)", marginBottom: "6px" }}>
                    ...
                    <Link
                        ...
                        style={{ color: "#5B8C5A", textDecoration: "none", borderBottom: "1px solid #5B8C5A" }}
                    >
                        {review.product_name}
                    </Link>
                </p>
                    ...
                    <p style={{ fontSize: "11px", color: "rgba(45,50,62,0.6)", lineHeight: 1.7, fontWeight: 500 }}>
                        ...
                        {review.body.length > 160 && (
                            <button
                                ...
                                style={{ marginLeft: "6px", fontSize: "9px", fontWeight: 900, textTransform: "uppercase" as const, letterSpacing: "0.1em", background: "none", border: "none", borderBottom: "1px solid #5B8C5A", cursor: "pointer", color: "#5B8C5A", padding: 0 }}
                            >
                                {expanded ? "Less" : "More"}
                            </button>
                        )}
