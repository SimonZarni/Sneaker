                                ...
                                {orders.map(o => (
                                    <div key={o.id} style={{ display: "grid", gridTemplateColumns: "1.5fr 60px 90px 110px 110px 60px", gap: "0", alignItems: "center", backgroundColor: "#fff", padding: "14px 24px" }}>
                                        ...
                                        <Link
                                            ...
                                            style={{ fontSize: "8px", fontWeight: 900, textTransform: "uppercase", letterSpacing: "0.1em", color: "#5B8C5A", textDecoration: "none", borderBottom: "1px solid #5B8C5A", paddingBottom: "1px", width: "fit-content" }}
                                        >
                                            View
                                        </Link>
                                    </div>
