                        ...
                        {filtered.map(c => (
                            ...
                            >
                                ...
                                <div style={{ display: "flex", gap: "8px" }}>
                                    <Link
                                        href={route("admin.customers.show", c.id)}
                                        style={{ fontSize: "8px", fontWeight: 900, textTransform: "uppercase", letterSpacing: "0.1em", color: "#5B8C5A", textDecoration: "none", borderBottom: "1px solid #0A0A0A", paddingBottom: "1px" }}
                                    >
                                        View
                                    </Link>
                                    <button
