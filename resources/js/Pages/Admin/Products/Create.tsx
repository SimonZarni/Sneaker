                        ...
                        <div style={S.card}>
                            ...
                            {variants.length === 0 && (
                                <div style={{ padding: "32px", textAlign: "center", border: "1px dashed #e5e7eb", backgroundColor: "#fafafa" }}>
                                    ...
                                    <button type="button" onClick={addVariant} style={{ fontSize: "9px", fontWeight: 900, textTransform: "uppercase", letterSpacing: "0.1em", color: "#5B8C5A", background: "none", border: "none", cursor: "pointer", borderBottom: "1px solid #0A0A0A", paddingBottom: "1px" }}>
                                        + Add first colorway
                                    </button>
                                </div>
                            )}
