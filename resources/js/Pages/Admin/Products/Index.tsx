            ...
            <div style={{ backgroundColor: "#fff", border: "1px solid #f0f0f0" }}>
                ...
                {products.data.length === 0 && (
                    <div style={{ padding: "80px 20px", textAlign: "center" }}>
                        ...
                        <Link href={route("admin.products.create")} style={{ fontSize: "9px", fontWeight: 900, textTransform: "uppercase", letterSpacing: "0.1em", color: "#5B8C5A", textDecoration: "none", borderBottom: "1px solid #5B8C5A", paddingBottom: "1px" }}>
