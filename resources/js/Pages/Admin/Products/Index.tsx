...
//         router.get(route("admin.products.index"), { search, brand: activeBrand, status: activeStatus, ...overrides }, { preserveState: true, replace: true });
//     };
...
//                 {/* Header row */}
//                 <div style={{ display: "grid", gridTemplateColumns: "56px 1fr 120px 100px 80px 80px 80px 120px", gap: "16px", padding: "12px 20px", borderBottom: "1px solid #f0f0f0" }}>
//                     {["", "Product", "Brand", "Category", "Gender", "Price", "Variants", "Actions"].map((h, i) => (
//                         <p key={i} style={{ fontSize: "9px", fontWeight: 900, textTransform: "uppercase", letterSpacing: "0.2em", color: "rgba(45,50,62,0.25)", textAlign: i >= 7 ? "right" : "left" }}>{h}</p>
//                     ))}
//                 </div>
...
//                     <div key={product.id} style={{ display: "grid", gridTemplateColumns: "56px 1fr 120px 100px 80px 80px 80px 120px", gap: "16px", alignItems: "center", padding: "14px 20px", borderBottom: "1px solid #fafafa" }}>
...
//                         <p style={{ fontSize: "11px", fontWeight: 700, color: "rgba(45,50,62,0.6)" }}>{product.gender}</p>
...
//                             <Link href={route("admin.products.edit", product.id)} style={{ fontSize: "9px", fontWeight: 900, textTransform: "uppercase", letterSpacing: "0.1em", color: "#0A0A0A", textDecoration: "none", padding: "6px 12px", border: "1px solid #e5e7eb" }}>
//                                 Edit
//                             </Link>
//                             <button
//                                 onClick={() => handleToggle(product.id)}
//                                 style={{ fontSize: "9px", fontWeight: 900, textTransform: "uppercase", letterSpacing: "0.1em", padding: "6px 10px", border: `1px solid ${product.is_active ? "#fde68a" : "#a7f3d0"}`, backgroundColor: product.is_active ? "#fffbeb" : "#ecfdf5", color: product.is_active ? "#b45309" : "#065f46", cursor: "pointer" }}
//                             >
//                                 {product.is_active ? "Deactivate" : "Activate"}
//                             </button>
//                             <button
//                                 onClick={() => handleDelete(product.id, product.name)}
//                                 style={{ fontSize: "9px", fontWeight: 900, textTransform: "uppercase", letterSpacing: "0.1em", padding: "6px 10px", border: "1px solid #fecaca", backgroundColor: "#fef2f2", color: "#dc2626", cursor: "pointer" }}
//                             >
//                                 Del
//                             </button>
//                         </div>
