            ...
            <main className="pt-32 pb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-16 border-b border-brand-surface pb-10">
                    ...
                    <div className="flex items-end justify-between">
                        <h2 className="text-4xl font-black tracking-tightest uppercase">Order History</h2>
                        <span className="text-[10px] font-bold uppercase tracking-widest text-brand-slate/40">
                            {orders.total} {orders.total === 1 ? "Drop" : "Drops"} Secured
                        </span>
                    </div>
                </div>
                    ...
                    <>
                        <div className="border border-brand-surface">
                            ...
                            {orders.data.map((order, idx) => (
                                <div key={order.id} className="group grid grid-cols-12 gap-4 items-center px-6 py-6 bg-brand-white hover:bg-brand-surface/40 transition-colors border-b border-brand-surface last:border-b-0">
                                    {/* Row # — uses from offset so page 2 starts at 11, not 1 */}
